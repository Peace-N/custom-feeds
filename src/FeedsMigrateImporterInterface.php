...
interface FeedsMigrateImporterInterface extends ConfigEntityInterface {
  ...
  /**
   * Counts items imported by this importer.
   *
   * @return int
   *   The number of items imported by this importer.
   */
  public function getItemCount();

  /**
   * Sets the number of items imported by this importer.
   *
   ...
   *
   * @return \Drupal\customfeeds\Entity\MigrationInterface
   ...
   *
   * @return \Drupal\customfeeds\FeedsMigrateExecutable
